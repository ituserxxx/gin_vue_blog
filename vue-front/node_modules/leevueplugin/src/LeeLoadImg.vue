<template>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px'}" v-if="thetype=='ball-pulse'">
    <span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px'}" v-else-if="thetype=='ball-wave'">
    <span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}"
       v-else-if="thetype=='rectangle'">
    <span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='square-move'">
    <span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px'}" v-else-if="thetype=='take-turn'">
    <span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px'}" v-else-if="thetype=='google'">
    <span></span><span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='radar-2'">
    <span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='radar-1'">
    <span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px'}" v-else-if="thetype=='progress'">
    <span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px'}"
       v-else-if="thetype=='zebra-crossing'">
    <span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='spinner'">
    <span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='ball-circle'">
    <span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}"
       v-else-if="thetype=='circle'">
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}"
       v-else-if="thetype=='circle-side'">
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}"
       v-else-if="thetype=='circle-arrow'">
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='flip-block'">
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,'--w':width+'px',width:width+'px',height:width+'px'}" v-else-if="thetype=='box'">
    <div class="boxn">
      <span></span><span></span><span></span><span></span><span></span><span></span>
    </div>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='swim-block'">
    <span></span><span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='croll-block'">
    <span></span><span></span><span></span><span></span><span></span>
  </div>
  <div class="lee-loading" :class="thetype" :style="{color:color,width:width+'px',height:width+'px'}" v-else-if="thetype=='wave'">
    <span></span>
  </div>
</template>
<script>
export default {
    ...
    watch: {
        type: {
            immediate: true,
            handler(value) {
                let types = ['circle', 'circle-side', 'circle-arrow', 'rectangle', 'square-move', 'ball-circle', 'ball-wave', 'take-turn', 'ball-pulse', 'radar-1', 'radar-2', 'spinner', 'progress', 'zebra-crossing', 'flip-block', 'box', 'swim-block', 'croll-block', 'wave']
                let fi = types.filter(function (el) {
                    return el.indexOf(value) > -1;
                })
                if (fi.length < 1) {
                    this.thetype = "ball-pulse"
                } else {
                    this.thetype = value
                }
            }
    ...
    props: {
        width: {
            type: Number,
            default: 30 //默认default
        },
        type: {
            type: String,
            default: 'ball-pulse' //默认default
        },
        color: {
            type: String,
            default: '#46bd87' //默认default
        }
    }
...
.lee-loading.radar-2 span {
  ...
  background-image: -webkit-linear-gradient(-135deg, currentColor 0%, transparent 50%);
...
.lee-loading.box span:nth-child(1) {
  background: rgba(70, 189, 135, .3);
  transform: translateZ(calc(var(--w)*1/2));
}
...
.lee-loading.box span:nth-child(3) {
  background: rgba(70, 189, 135, .8);
  transform: rotateX(90deg) translateZ(calc(var(--w)*1/2));
}
...
.lee-loading.box span:nth-child(5) {
  background: rgba(70, 189, 135, .6);
  transform: rotateY(90deg) translateZ(calc(var(--w)*-1/2));
}
