...
.btnexp{height:44px;position: relative;display:flex;justify-content: center;align-items: center;cursor:pointer;border-top:solid 1px #eaecef;transition: all .3s;color: #ddd;margin-top: -1px;}
.btnexp i{
        border-width: 4px;
