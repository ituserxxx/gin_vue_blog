<template>
  <div class="lee-luck-grid" :style="styleLuckGrid">
    <div class="waterMark" style="display: block!important;">Leeao版权所有</div>
...
export default {
    ...
    methods: {
        styleGrid(item) {
            ...
            let shadow=this.config.grid.shadow
            return {
                width: w + 'px',
                height: w + 'px',
                background: bgColor,
                ...
                top: y + 'px',
                color: fontColor,
                boxShadow:typeof(shadow)==='boolean'?'none':shadow.x+'px '+shadow.y+'px 0px rgba(0,0,0,.2)'
                //'--iw': item.img.width
            }
        },
        click() {
