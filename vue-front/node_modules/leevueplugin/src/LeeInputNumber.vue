<template>
    <div class="el-input-number">
        <span role="button" class="el-input-number_decrease" :class="{'is-disabled':currentValue<=min?true:false}"><i @click="dec">-</i></span>
        <span role="button" class="el-input-number_increase" :class="{'is-disabled':currentValue>=max?true:false}"><i @click="inc">+</i></span>
        <div class="el-input">
...
.el-input-number_decrease.is-disabled i,.el-input-number_increase.is-disabled i{
    pointer-events: none;
}
</style>
