<template>
  <div class="lee-scroll-select" :style="{color:color}">
    <transition name="slideUp">
      <div class="tandiv" v-if="show">
        <div class="okdiv" @click="chuli"><span>关闭</span></div>
          ...
          <div class="myk">
            ...
            <div class="cus"></div>
             <div class="zz" @mousedown.prevent="mousedown('year')" @mousemove.prevent="mousemove"
                @mouseup.stop="mouseup" @mouseleave="mouseleave" @touchstart.prevent="touchstart('year')" @touchmove.prevent="touchmove"
          ...
          <div class="myk">
            ...
            <div class="cus"></div>
             <div class="zz" @mousedown.prevent="mousedown('month')" @mousemove.prevent="mousemove"
                @mouseup.stop="mouseup" @mouseleave="mouseleave" @touchstart.prevent="touchstart('month')" @touchmove.prevent="touchmove"
                @touchend.stop="touchend"></div>
          </div>
          <div class="myk">
            <div class="tit">日</div>
            ...
            <div class="cus"></div>
             <div class="zz" @mousedown.prevent="mousedown('day')" @mousemove.prevent="mousemove"
                @mouseup.stop="mouseup" @mouseleave="mouseleave" @touchstart.prevent="touchstart('day')" @touchmove.prevent="touchmove"
                @touchend.stop="touchend"></div>
          </div>
        </template>
          ...
          <div class="myk">
            ...
            <div class="cus"></div>
             <div class="zz" @mousedown.prevent="mousedown('hour')" @mousemove.prevent="mousemove"
                @mouseup.stop="mouseup" @mouseleave="mouseleave" @touchstart.prevent="touchstart('hour')" @touchmove.prevent="touchmove"
                @touchend.stop="touchend"></div>
          </div>
          <div class="myk">
            <div class="tit">分</div>
            ...
            <div class="cus"></div>
             <div class="zz" @mousedown.prevent="mousedown('min')" @mousemove.prevent="mousemove"
                @mouseup.stop="mouseup" @mouseleave="mouseleave" @touchstart.prevent="touchstart('min')" @touchmove.prevent="touchmove"
          ...
          <div class="myk">
            ...
            <div class="cus"></div>
             <div class="zz" @mousedown.prevent="mousedown('sec')" @mousemove.prevent="mousemove"
                @mouseup.stop="mouseup" @mouseleave="mouseleave" @touchstart.prevent="touchstart('sec')" @touchmove.prevent="touchmove"
                @touchend.stop="touchend"
                ></div>
          </div>
        </template>
