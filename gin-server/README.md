...
## mysql 容器
docker run -it -d -p 3306:3306 --name=mysql8  --restart=always -e MYSQL_ROOT_PASSWORD=root -v /data/docker-continaer/mysql/conf:/etc/mysql/conf.d -v  /data/docker-continaer/mysql/logs:/logs -v  /data/docker-continaer/mysql/data:/var/lib/mysql mysql:8 
docker run -it -d -p 3306:3306 -p 33060:3306 --name=mysql8  --restart=always -e MYSQL_USER=root -e MYSQL_ROOT_PASSWORD=jiaobaba -v /data/mysql/conf.d:/etc/mysql/conf.d -v  /data/mysql/logs:/logs -v  /data/mysql/data:/var/lib/mysql mysql:8 
