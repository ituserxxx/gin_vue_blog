...
<head>
    <title>Code coverage report for utils/crc32.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">utils</a> crc32.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">3670016x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  private async readAsUint8Array(file: File | Blob): Promise&lt;Uint8Array&gt; {
    if (<span class="missing-if-branch" title="else path not taken" >E</span>typeof file.arrayBuffer === 'function') {
<span class="cstat-no" title="statement not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >      return new <span class="cstat-no" title="statement not covered" >Uint8Array(<span class="cstat-no" title="statement not covered" >a</span>wait file.arrayBuffer())</span></span></span>
    }
&nbsp;
    return new Promise((resolve, reject) =&gt; {
      const reader = new FileReader()
      reader.onload = () =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (reader.result == null) {
<span class="cstat-no" title="statement not covered" >          reject()</span>
<span class="cstat-no" title="statement not covered" >          return</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof reader.result === 'string') {
<span class="cstat-no" title="statement not covered" >          reject()</span>
<span class="cstat-no" title="statement not covered" >          return</span>
        }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static f</span>ile(file: File): Promise&lt;number&gt; {
    const crc = <span class="cstat-no" title="statement not covered" >new CRC32()</span>
<span class="cstat-no" title="statement not covered" >    return crc.file(file)</span>
  }
}
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Oct 18 2021 09:23:32 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
