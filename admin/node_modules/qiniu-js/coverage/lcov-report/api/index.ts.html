...
export function <span class="fstat-no" title="function not covered" >uploadChunk(</span>
  ...
  const headers = <span class="cstat-no" title="statement not covered" >utils.getHeadersForChunkUpload(token)</span>
<span class="cstat-no" title="statement not covered" >  if (options.md5) <span class="cstat-no" title="statement not covered" >headers['Content-MD5'] = options.md5</span></span>
&nbsp;
